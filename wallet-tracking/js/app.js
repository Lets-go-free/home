// Phase 6.16 · 25.09.2026 17:00:28 CEST: P4 Ownership-Lifecycle-Lücke wird vollständig vermessen; keine Fachlogik-/Performanceänderung. Build 20260925-170028.
...
const LIFECYCLE_ARCH_AUDIT_ITEMS = [
  ...
  {priority:"P4", workStatus:"in Arbeit", severity:"high", area:"Performance Fresh-Import", finding:"6.13-Realtest: Wallet-Erstimport 37'233 ms, DAO1 25'103 ms. 6.15 zeigte starke Laufzeitschwankung: 94'049 ms bzw. 59'250 ms Gesamt. Im zweiten 6.15-Lauf meldete der Lifecycle nftOwnership 22'482 ms, während die bisherige Innenmessung nur 10'628 ms (prewarm 3'493 / rebuild 6'946 / readback 190) erklärte. Die Differenz liegt damit vor dem bisherigen Prewarm-Messpunkt bzw. in noch nicht erfasster Vorbereitung.", action:"Phase 6.16 ändert keine Fach- oder Performance-Logik. Der komplette Ownership-Lifecycle wird zusätzlich in current inventory, prepare, prewarm, rebuild und readback zerlegt; lifecycleMs und unaccountedMs werden direkt sichtbar ausgegeben. Erst danach wird über eine weitere Optimierung entschieden."},
