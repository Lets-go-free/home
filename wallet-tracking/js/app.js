// Phase 6.05 · 24.09.2026 11:12:50 CEST: Audit P3 bleibt bis Praxistest in Arbeit; historische outgoing-only Ownership-Evidenz schliesst Fresh-Build-Lücken ohne erfundenes Erwerbsdatum. Supabase Schema/GRANT-Regel dokumentiert. Build 20260924-111250.
...
const LIFECYCLE_ARCH_AUDIT_ITEMS = [
  ...
  {priority:"P3", workStatus:"in Arbeit", severity:"critical", area:"Fresh-Build-Parität", finding:"Praxistest 6.04: 20 historische NFT-Kandidaten wurden korrekt gefunden, blieben aber als Ownership-Lücken offen, weil bei einzelnen historischen NFTs nur ein belegter Wallet-Abgang und kein vollständiger früherer Eingang verfügbar war.", action:"Phase 6.05: outgoing-only On-Chain-Evidenz wird als geschlossene historische Ownership-Periode mit unbekanntem Start gespeichert; es wird kein Erwerbsdatum erfunden. P3 bleibt bis zum erneuten Fresh-Build-Test in Arbeit; erst bei ownershipConsistency=complete wird P4 freigegeben."},
...
function renderHardcodingAudit(){
  ...
  el.innerHTML=`
    <div class="custom-token-card" style="margin-bottom:16px">
      <h3 style="margin-top:0">Lifecycle-/Architektur-Audit · Phase 6.05</h3>
