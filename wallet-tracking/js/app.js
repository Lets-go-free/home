...
const LIFECYCLE_ARCH_AUDIT_ITEMS = [
  ...
  {priority:"P3", workStatus:"erledigt", severity:"critical", area:"Fresh-Build-Parität", finding:"Neuer User konnte nach identischem Wallet-Import einen anderen fachlichen Zustand als ein langjähriger User erreichen, weil historische NFT-Kandidaten faktisch von bereits vorhandener project_nft_ownership-Historie abhängen konnten.", action:"Phase 6.04: Historische DAO1/APTMDAO-NFT-Kandidaten werden beim Fresh-Build aus der Wallet-Transferhistorie bekannter Projekt-Contracts rekonstruiert; aktuelle und historische Ownership werden deterministisch aufgebaut. Der Legacy-Self-Heal ist kein automatischer Fresh-Build-Pfad mehr und keine Voraussetzung der Fresh-Build-Korrektheit."},
...
function renderHardcodingAudit(){
  ...
  el.innerHTML=`
    <div class="custom-token-card" style="margin-bottom:16px">
      <h3 style="margin-top:0">Lifecycle-/Architektur-Audit · Phase 6.04</h3>
