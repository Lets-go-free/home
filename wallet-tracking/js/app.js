/* WalletTracking Phase 5.45 · 19.09.2026 23:10:56 CEST · Build 20260919-231056 */
...
const ADMIN_SYSTEM_TREE = [
  ...
  {id:"dao-team",level:2,label:"Team",status:"in_progress",start:"–",daily:"–",open:"🟢 IDB + Version",manual:"🟡 On-chain Update",details:[
    ...
    ["DAO Partner-Bot-Lifecycle","RAM + Dashboard-Summary","dao_partner_bot_lifecycle_cache","Apertum Explorer nur beim gezielten Öffnen von Partnerdetails","Phase 5.45: Tree-Render bleibt cache-only; gleiche Explorer-Requests werden dedupliziert und Erwerbsprüfungen auf 2 parallel begrenzt. Identitäts-NFTs werden nie als Bots geführt. Die Wallet-Fallback-Zuordnung ist entfernt: APTMDAO-Bots brauchen positiven Nachweis aus Erwerbs-Tx/APTMDAO-Manager; alte DAO1-Bots bleiben in der bewährten Legacy-Logik, solange kein positiver APTMDAO-Nachweis vorliegt. Alte unique_tree_wallet-Cachezeilen werden im Dashboard ignoriert. Migration 065."],
