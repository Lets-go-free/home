...
const LIFECYCLE_ARCH_AUDIT_ITEMS = [
  ...
  {priority:"P3", workStatus:"in Arbeit", severity:"critical", area:"Fresh-Build-Parität", finding:"Praxistest 6.07: 20 Ownership-Perioden werden geschrieben und per erzwungenem DB-Fresh-Read vollständig wieder gelesen; trotzdem meldete die Lifecycle-Prüfung exakt 20 Lücken. Damit ist Write→Readback ausgeschlossen. Ursache: Lifecycle-Konsistenz verwendete weiterhin einen zu strengen Maßstab für Erwerbs-/Historien-Enrichment.", action:"Phase 6.08 trennt Lifecycle-Besitzabdeckung und Enrichment-Repair endgültig. Für den Lifecycle genügt ein persistierter aktueller is_current-Nachweis bzw. eine persistierte historische Ownership-Evidenz. Fehlender Erwerbsbeginn, Mint/Kauf-Wallet oder Kaufpreis bleiben im strengeren Repair-Pfad offen und dürfen den Wallet-Bootstrap nicht mehr auf partial halten. P3 bleibt bis Retest in Arbeit; erst bei ownershipConsistency=complete wird P4 freigegeben."},
...
function renderHardcodingAudit(){
  ...
  el.innerHTML=`
    <div class="custom-token-card" style="margin-bottom:16px">
      <h3 style="margin-top:0">Lifecycle-/Architektur-Audit · Phase 6.08</h3>
