// Phase 6.06 · 24.09.2026 11:48:55 CEST: Audit P3 Current-State-Evidenz: aktueller Besitz und Erwerbsbeginn getrennt; current_state_evidence_only schliesst Besitzabdeckung ohne erfundenes Erwerbsdatum. P3 bleibt bis Retest in Arbeit. Build 20260924-114855.
...
const LIFECYCLE_ARCH_AUDIT_ITEMS = [
  ...
  {priority:"P3", workStatus:"in Arbeit", severity:"critical", area:"Fresh-Build-Parität", finding:"Praxistests 6.04/6.05: 20 NFT-Kandidaten werden gefunden; die Ownership-Discovery läuft fehlerfrei, aber ownershipConsistency blieb partial, weil aktueller Besitz und vollständig bekannter Erwerbsbeginn bisher als dieselbe Konsistenzbedingung behandelt wurden.", action:"Phase 6.06 trennt Besitzabdeckung von Erwerbs-Evidenz: Für aktuell im zentralen NFT-Current-State belegte NFTs darf eine persistierte current_state_evidence_only-Periode den Current-State-Lifecycle abschließen, auch wenn owned_from_* unbekannt bleibt. Der strengere Repair-/UI-Pfad bleibt offen und darf später den echten Erwerbsbeginn nachziehen. Historische outgoing-only Evidenz aus 6.05 bleibt unverändert. P3 bleibt bis Retest in Arbeit; erst bei ownershipConsistency=complete wird P4 freigegeben."},
...
function renderHardcodingAudit(){
  ...
  el.innerHTML=`
    <div class="custom-token-card" style="margin-bottom:16px">
      <h3 style="margin-top:0">Lifecycle-/Architektur-Audit · Phase 6.06</h3>
