// Phase 6.15 · 25.09.2026 14:10:35 CEST: P4 6.14-Regression verworfen; Basis wieder 6.13. Audit dokumentiert 6.13 als Referenz und 6.15 misst nur den verbleibenden Ownership-Block. Build 20260925-141035.
...
const LIFECYCLE_ARCH_AUDIT_ITEMS = [
  ...
  {priority:"P4", workStatus:"in Arbeit", severity:"high", area:"Performance Fresh-Import", finding:"6.13-Realtest: Wallet-Erstimport 37'233 ms, DAO1 25'103 ms. Claims fielen auf 3'681 ms, assetFlows auf 1'471 ms; verbleibender Hauptblock ist NFT-Ownership mit 13'299 ms. Phase 6.14 (Prewarm-First/Explorer-Fallback) regressierte im Realtest auf 43'377 ms Gesamt und 16'868 ms NFT-Ownership und wird deshalb verworfen.", action:"Phase 6.15 basiert wieder auf der fachlich und zeitlich besseren 6.13. Keine Ownership-Fachlogikänderung; nur direkte Feintiming-Ausgabe für prewarmMs, rebuildMs und readbackMs, damit der 13-s-Restblock ohne weitere Blindoptimierung zerlegt werden kann."},
