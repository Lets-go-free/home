...
const ADMIN_SYSTEM_TREE = [
  ...
  {id:"dao-team",level:2,label:"Team",status:"in_progress",start:"–",daily:"–",open:"🟢 IDB + Version",manual:"🟡 On-chain Update",details:[
    ...
    ["DAO Partner-Bot-Lifecycle","RAM + Dashboard-Summary","dao_partner_bot_lifecycle_cache","Apertum Explorer nur beim gezielten Öffnen von Partnerdetails","Phase 5.48: Tree-Render bleibt cache-only. Eigene historisch verifizierte Bots dürfen ihren gespeicherten ersten Besitzabschnitt als Erwerbsnachweis verwenden, auch wenn die alte DAO1-Zahlungsstruktur keinen Kaufpreis erneut liefert. Fremde/live Bots benötigen weiterhin echten Kaufnachweis. Bot→DID bleibt strikt historisch: Erwerbs-Wallet + DID-Besitz am Erwerbsblock. Identitäts-NFTs werden nicht als Bots/Membership-Zeile dupliziert. Migration 065."],
