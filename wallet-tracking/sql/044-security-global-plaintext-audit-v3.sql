...
from (
  ...
  select
    2 as sort_order,
    '=== OVERALL ==='::text as object_name,
    'SUMMARY'::text as category,
    sum(total_rows)::bigint as total_rows,
    sum(private_plaintext_rows)::bigint as private_plaintext_rows,
    0::bigint as expected_private_plaintext_rows,
