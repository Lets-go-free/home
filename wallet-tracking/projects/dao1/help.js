// Phase 5.89 · 22.09.2026 03:05:55 CEST: 5.88-NFT-Metadaten-/Ownership-Normalisierung als automatische DATA_MIGRATION; kein manueller NFT-Refresh für Release-Nachzug nötig. Build 20260922-030555.
...
function renderDAO1Help(){
  ...
  el.innerHTML=`<div class="custom-token-card"><h3 style="margin-top:0">DAO1 / Apertum · Hilfe</h3><p class="note">Diese Hilfe beschreibt ausschließlich die DAO1-/Apertum-Funktionen. Allgemeine WalletTracking-Funktionen stehen unter „❓ Hilfe / Handbuch“.</p></div>
          ...
          <div class="custom-token-card"><h3 style="margin-top:0">Caching &amp; Aktualisierung</h3><p class="note">Transaktions-, Claim-, NFT- und LP-Historien werden persistent gespeichert und inkrementell ergänzt. Bereits bekannte Historie soll nicht unnötig neu geladen werden. Beim manuellen Apertum-NFT-Refresh wird nach dem Current-State-Abgleich gezielt geprüft, ob für aktuelle NFTs noch Ownership-/Erwerbslücken bestehen; nur diese Lücken werden erneut aufgebaut. <strong>Phase 5.89:</strong> die mit 5.88 eingeführte NFT-Metadaten-/Ownership-Normalisierung ist zusätzlich als zentrale DATA_MIGRATION registriert und wird beim ersten Start nach dem Release automatisch einmal pro User ausgeführt; ein manueller Klick auf „NFTs aktualisieren“ ist dafür nicht mehr erforderlich. Partielle oder fehlgeschlagene Ownership-Prüfungen gelten nicht als dauerhaft erledigt. Neue Blockchain-Aktivität, Besitzerwechsel, Claims oder andere veränderliche Zustände müssen bei einer Aktualisierung trotzdem erkannt werden.</p><p class="note"><strong>APTM/wAPTM-Kurse:</strong> APTM und wAPTM werden 1:1 behandelt. Der USD-Kurs wird on-chain aus dem wAPTM/wUSDT-Referenzpool <code>0x38Ac…89b57</code> ermittelt. Der erste belastbare Marktpreis beginnt mit Pair-Erstellung und erster Liquidität in Block 88'356 am 18.02.2025 12:39:52 UTC. Für frühere Blöcke wird kein späterer Kurs zurückgerechnet, sondern „Noch kein On-Chain-Marktpreis vorhanden“ verwendet.</p></div>`;
}
