...
- Audit P3 Regression: Frischer User ohne project_nft_ownership muss aus derselben Wallet dieselben aktuellen UND historischen DAO1/APTMDAO-NFTs/Bots/DIDs aufbauen können wie ein bestehender User. Phase 6.09-Retest bestätigte ownershipConsistency=complete und Lifecycle complete. Der NFT-Tab zeigte den finalen Besitz-/Erwerbsstand jedoch erst nach Hard-Refresh; danach waren Erwerbsdatum, Wallet und Block vorhanden, Kaufpreise aber weiterhin teilweise nicht ermittelt. Phase 6.10 lädt nach dem Fresh-Build Ownership und globalen Ersterwerb autoritativ neu, rendert den NFT-Tab ohne Browser-Reload und prüft Kaufpreise aus der frühesten eigenen Entry-Tx. P3 bleibt bis Realtest inkl. Kaufpreis-Parität in Arbeit. P4-Performance wird parallel nur gemessen.
