// Phase 6.06 · 24.09.2026 11:48:55 CEST: Audit P3 trennt Current-State-Besitz von Erwerbs-Evidenz; current_state_evidence_only darf Besitzabdeckung abschliessen, Repair für Erwerbsdatum/Kaufpreis bleibt offen. Build 20260924-114855.
...
const ADMIN_IDEAS = [
  {
    ...
    desc: `OFFENE TESTS nach Phase 6.06:
...
- Audit P3 Regression: Frischer User ohne project_nft_ownership muss aus derselben Wallet dieselben aktuellen UND historischen DAO1/APTMDAO-NFTs/Bots/DIDs aufbauen können wie ein bestehender User. Historische Kandidaten werden aus Wallet-NFT-Transferhistorien der bekannten Projekt-Contracts ermittelt; bestehende User-Caches dürfen nicht Voraussetzung sein. Phase 6.06: Aktueller Besitz und Erwerbsbeginn sind getrennte Evidence-Stufen. Wenn der Current-State den heutigen Besitz beweist, darf current_state_evidence_only ownershipConsistency abschließen; Erwerbsdatum/Kaufpreis bleiben sichtbar offen und der strengere Repair-Pfad darf sie später nachziehen. Historische outgoing-only Evidenz bleibt ebenfalls ohne erfundenen Start zulässig.
