...
const ADMIN_IDEAS_MODULE_BUILD = "20260915-160431";
const ADMIN_IDEAS_MODULE_TIMESTAMP = "15.09.2026 16:04:31 CEST";
...
• TLN Gold Extended: neuen Rückzahlungsbetrag und eigenen Zins der neuen Position on-chain ermitteln; keine Übernahme aus Alt-Loan und keine rechnerische Ableitung
  ...
  - UMGESETZT 15.09.2026: Bei Zieltyp 5 aktiviert der DEV-Repay-Prüfer standardmäßig automatisch die vollständige historische Suchtiefe bis 10’000 globale Repay-Transaktionen. Ein leerer Lauf weist Suchumfang und fehlenden Beleg ausdrücklich aus; es wird weiterhin kein Zinsmodell geraten. Für Branch-Prüfungen besitzt die Discovery-Testseite auf localhost jetzt eine eigene Supabase-Magic-Link-Anmeldung; auf produktiven Hosts bleibt sie verborgen. Einmalige Voraussetzung ist die Freigabe der lokalen Test-URL in Supabase Auth → URL Configuration → Redirect URLs. NÄCHSTE PRÜFUNG: Lauf im lokal authentifizierten Discovery-Test ausführen und Ergebnis dokumentieren. Bei einem Treffer Typ-5-Principal, tatsächliche Zahlung und Differenz positionsgenau übernehmen; bei keinem Treffer bleibt Zins/Rückzahlung offen.
