// Phase 6.07 · 24.09.2026 12:12:33 CEST: Audit P3 Fresh-Read-Readback nach Ownership-Mutationen; stale Promise/Runtime-Read darf Konsistenzprüfung nicht verfälschen. Build 20260924-121233.
...
const ADMIN_IDEAS = [
  {
    ...
    desc: `OFFENE TESTS nach Phase 6.07:
...
- Audit P3 Regression: Frischer User ohne project_nft_ownership muss aus derselben Wallet dieselben aktuellen UND historischen DAO1/APTMDAO-NFTs/Bots/DIDs aufbauen können wie ein bestehender User. Historische Kandidaten werden aus Wallet-NFT-Transferhistorien der bekannten Projekt-Contracts ermittelt; bestehende User-Caches dürfen nicht Voraussetzung sein. Phase 6.06 trennt aktuellen Besitz und Erwerbsbeginn als Evidence-Stufen. Phase 6.07 korrigiert zusätzlich den Write→Readback-Pfad: Nach Ownership-Mutationen muss ein echter neuer DB-Read erfolgen; ein bereits laufendes älteres Ownership-Promise darf nicht als Konsistenzgrundlage wiederverwendet werden. Der Retest muss ownershipConsistency=complete sowie einen plausiblen DAO1 NFT Ownership Fresh-Readback zeigen.
