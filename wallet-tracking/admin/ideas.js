...
- Audit P3 Regression: Frischer User ohne project_nft_ownership muss aus derselben Wallet dieselben aktuellen UND historischen DAO1/APTMDAO-NFTs/Bots/DIDs aufbauen können wie ein bestehender User. Historische Kandidaten werden aus Wallet-NFT-Transferhistorien der bekannten Projekt-Contracts ermittelt; bestehende User-Caches dürfen nicht Voraussetzung sein. Phase 6.06 trennt aktuellen Besitz und Erwerbsbeginn als Evidence-Stufen. Phase 6.07 hat den Write→Readback-Pfad verifiziert: 20 geschriebene Ownership-Perioden werden vollständig frisch aus der DB zurückgelesen. Phase 6.08 trennt deshalb Lifecycle-Besitzabdeckung vom strengeren Enrichment-Repair. Der 6.08-Retest zeigte dennoch 20/20 Lifecycle-Lücken, obwohl Fresh-Readback totalRows=20 und walletRows=20 bestätigte. Ursache war danach nachweisbar die Cache-Priorität: loadDashboardSummary() konnte den frischen DB-Stand wieder mit dem älteren zentralen Shared-Cache überschreiben. Phase 6.09 verhindert dieses Downgrade. Der Retest muss ownershipConsistency=complete zeigen.
