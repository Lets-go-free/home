// Phase 6.14 · 25.09.2026 13:57:01 CEST: P4 6.13-Realtest 37.2 s Gesamt; Claims 3.7 s, NFT-Ownership 13.3 s. Ownership-Fresh-Build entfernt redundante per-NFT Explorer-Reads; NFT-Kaufpreis-Finalisierung begrenzt parallel. Build 20260925-135701.
...
- Audit P3 Regression: Realtest 6.11 abgeschlossen. Fresh-Build ist beim NFT-Bestand/Ownership/Ersterwerb und den bekannten historischen Kaufpreisen deckungsgleich zum Entwicklungs-Testuser. #38483 löst wieder 10’000 wUSDT über Tx 0x31cd…1de2 auf; weitere bekannte Referenzen (#31722, #90227, #90289, #37174) stimmen ebenfalls. Bewusst nicht deterministisch verknüpfbare Kauf-/Mint-Batches bleiben offen. Phase 6.12 persistiert auch diese bewusst offenen Resolver-v3-Ergebnisse samt Erwerbs-Evidenz, damit der erste NFT-Tab-Einstieg keinen identischen Kaufpreis-Lauf erneut startet. P3 = erledigt. P4 bleibt aktiv: 6.12 senkte assetFlows im Realtest auf 1’706 ms und den gesamten Erstimport auf 85’093 ms. Die verbleibenden Hotspots sind Claims 39’819 ms und NFT-Ownership 23’421 ms. Phase 6.13 batchete die Claim-TX-Markierungen und parallelisierte den Ownership-Rebuild begrenzt; der Realtest sank auf 37’233 ms Gesamt / 25’102 ms DAO1, Claims 3’681 ms und NFT-Ownership 13’299 ms. Phase 6.14 entfernt im Ownership-Restpfad redundante per-NFT Explorer-Metadaten-/Instance-Reads, wenn die bereits vorgewärmten globalen und Wallet-Historien ausreichen; direkte Explorer-Reads bleiben Fallback. Die zentrale Kaufpreis-Finalisierung nutzt denselben Resolver mit maximal vier parallelen Auflösungen. Kaufpreis-/Asset-Flow-Fachlogik bleibt unverändert.
