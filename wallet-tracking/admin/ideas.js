...
- Audit P3 Regression: Frischer User ohne project_nft_ownership muss aus derselben Wallet dieselben aktuellen UND historischen DAO1/APTMDAO-NFTs/Bots/DIDs aufbauen können wie ein bestehender User. 6.10 bestätigte Lifecycle/Ownership und zeigte zugleich die Kaufpreis-Regression: bei #38483 wurde der spätere Wallet-Eingang 2026 geprüft, obwohl der verifizierte historische Kauf 10’000 wUSDT in Tx 0x31cd…1de2 liegt. Phase 6.11 zentralisiert die Zahlungsprüfung und sucht bei einer preislosen Wallet-Eingangs-Tx rückwärts in der globalen NFT-Transferkette nach der letzten eindeutig belegten Kauf-Tx. Verifizierte v2-Preise bleiben gültig; alte negative v2-Befunde werden mit Resolver v3 erneut geprüft. Separate Kauf-/Mint-Batches (Launch/Bonus) werden nicht heuristisch gekoppelt oder auf mehrere Bots verteilt. P3 bleibt bis Realtest der Kaufpreis-Parität in Arbeit. P4 ist gemessen: assetFlows 606’115 ms von 667’118 ms DAO1 (~91 %).
