// Phase 6.05 · 24.09.2026 11:12:50 CEST: Audit P3 Nachbesserung nach Praxistest: 20 outgoing-only historische NFT-Evidenzen werden ohne erfundenen Erwerbsbeginn persistiert; P3 bleibt bis Retest in Arbeit. Verbindliche Supabase-Schema-/GRANT-Regel ergänzt. Build 20260924-111250.
...
const ADMIN_IDEAS = [
  {
    ...
    desc: `OFFENE TESTS nach Phase 6.05:
...
- Audit P3 Regression: Frischer User ohne project_nft_ownership muss aus derselben Wallet dieselben aktuellen UND historischen DAO1/APTMDAO-NFTs/Bots/DIDs aufbauen können wie ein bestehender User. Historische Kandidaten werden aus Wallet-NFT-Transferhistorien der bekannten Projekt-Contracts ermittelt; bestehende User-Caches dürfen nicht Voraussetzung sein. Phase 6.05: Bei outgoing-only Evidenz darf der Erwerbsbeginn unbekannt bleiben, aber ownershipConsistency muss nach Speicherung der belegten Abgangsperiode complete werden.
